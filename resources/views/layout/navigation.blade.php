<header class="absolute inset-x-0 top-0 z-50">
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:gap-x-12 lg:justify-center w-full max-w-screen-lg mx-auto translate-x-[-2em]">
            <a href="{{ route('customers.purchases.create', 1) }}" class="text-sm font-bold text-gray-900 hover:text-indigo-600 transform hover:scale-105 transition duration-300 ease-in-out">
                Add Purchase
            </a>
            <a href="{{ route('purchases.index') }}" class="text-sm font-bold text-gray-900 hover:text-indigo-600 transform hover:scale-105 transition duration-300 ease-in-out">
                Report
            </a>
        </div>
            ...
            <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/10">
                    <div class="space-y-2 py-6">
                        <a href="{{ route('customers.purchases.create', 1) }}" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold text-gray-900 hover:bg-gray-50">Add Purchase</a>
                        <a href="{{ route('purchases.index') }}" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold text-gray-900 hover:bg-gray-50">Report</a>
                    </div>
                </div>
            </div>
        </div>
